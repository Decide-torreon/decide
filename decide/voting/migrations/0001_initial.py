# Generated by Django 2.0 on 2022-01-05 11:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Importante', 'Importante'), ('Informativa', 'Informativa'), ('Urgente', 'Urgente'), ('Prueba', 'Prueba')], max_length=1000)),
                ('url', models.CharField(help_text='http://localhost:8000/booth/', max_length=40, null=True)),
